<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bb.aspx.cs" Inherits="Registration.bb" %>
...
<body>
    ...
    <?php include 'nav.aspx' ?>
        <div class="control">
            ...
            <div class="nav">
                <ul>
                    <li><a href="main.aspx">Home</a><span>>> Black Bunny</span> </li>
                </ul>
            </div>
        </div>
    ...
    <div id="about">
        <div class="aboutinfo">
            ...
            <a href="timebb.aspx"><button>Book Now</button></a>
        </div>
        <div class="aboutimg">
