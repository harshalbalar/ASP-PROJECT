<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rebounce.aspx.cs" Inherits="Registration.rebounce" %>
...
<body>
    ...
    <?php include 'nav.aspx'?>
            <div class="control">
                ...
                <div class="nav">
                    <ul>
                        <li><a href="main.aspx">Home</a><span>>> Rebounce</span> </li>
                    </ul>
                </div>
            </div>
    ...
    <div id="about">
        <div class="aboutinfo">
            ...
            <a href="../project/timerebounce.aspx"><button>Book Now</button></a>
        </div>
        <div class="aboutimg">
