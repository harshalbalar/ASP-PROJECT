<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shott.aspx.cs" Inherits="Registration.shott" %>
...
<body>
    ...
    <?php include 'nav.aspx'?>
        <div class="control">
            ...
            <div class="nav">
                <ul>
                    <li><a href="main.aspx">Home</a><span>>> Shott</span> </li>
                </ul>
            </div>
        </div>
    ...
    <div id="about">
        <div class="aboutinfo">
            ...
            <a href="../project/timeshot.aspx"><button>Book Now</button></a>
        </div>
        <div class="aboutimg">
